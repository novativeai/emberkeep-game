eleanor_wat-is-going-on-guys — After Effects PNG sequence (character-bank sequence)
Generated by posesheet.py from a 4x2 Sprite Studio grid sheet

Character   : eleanor
Sequence    : wat-is-going-on-guys
Files       : 20 PNGs — one per animation frame, 989x1416 px, straight alpha
...
1. File > Import > File…
2. Select eleanor_wat-is-going-on-guys_00000.png and enable "PNG Sequence".
