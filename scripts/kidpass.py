...
TUTORIAL = {
  ...
  'name_choose': "Type a name and tap OK. She will keep it forever.",
  ...
  'codex_shut': "That is the Dragon Codex. Open it any time you like. Tap ✕ to close it.",
  ...
  'resin_pocket': "One Sap Drop rolled away. Tap it to put it in your Bag. You will need it in a moment.",
  'house_commission': "Tap your House, then pick the Sap Drop from your Bag. Now your House makes Sap Drops forever!",
