...
QUESTS = {
  ...
  'north_strakes': ('Brew Tar Buckets', {'strakes_brew': 'Brew 2 Tar Buckets in the Cauldron'}),
  ...
  'north_threadwork': ('Brew Light Cloth', {'thread_brew': 'Brew 2 Light Cloths from Spyglasses'}),
  ...
  'north_pitchpot': ('Racks for a New Oven', {'pitchpot_brew': 'Brew 3 Oven Racks'}),
  'north_door': ("Open Selyna's Castle", {'door_open': 'Use 2 Gold Keys on the clouds around the castle'}),
  'north_lamplight': ('Lamps for the Long Night', {'lamplight_brew': 'Brew 2 Big Lanterns'}),
  ...
  'north_lodestones': ('Make Compass Needles', {'lodestones_brew': 'Brew 2 Compass Needles'}),
  'north_hulls': ('Make Two Horned Helmets', {'hulls_pair': 'Make 2 Horned Helmets'}),
  'north_skeins': ('Brew Spinning Wheels', {'skeins_brew': 'Brew 2 Spinning Wheels'}),
  'north_pitchworks': ('Make an Ember Heart', {'pitchworks_ember': 'Make 1 Ember Heart'}),
  'north_runeshards': ('Carve a Rune', {'runeshards_brew': 'Brew a Carved Rune from an Ember Heart'}),
...
CAULDRON = {
  ...
  'iron_cap': ("Melt two Glass Floats, and the iron from their nets comes out — enough for a whole helmet.", "Iron Helmets are hard to find. This makes them faster."),
  'light_thread': ("Break two Spyglasses into lenses, hold them up to the northern lights, and the colour weaves itself.", "Makes Light Cloth without building a whole Star Machine."),
  ...
  'oil_lamp': ("Tar to burn twice over, Fire Juice for the light, and wicks for both.", "3 Big Lanterns make a Warm Lamp. Only a few were ever left on the ice."),
  'lodestone': ("A Magic Rock and an Iron Helmet argue until a needle points north.", "3 Compass Needles make a Treasure Compass, which makes Gold forever."),
  'woven_bolt': ("Two Light Cloths and a Spyglass to hold them apart while they set.", "Selyna's last order asks for Aurora Cloaks. This weaves one whole."),
  'rune_shard': ("An Ember Heart burns hot enough to fuse a Magic Rock into one carved rune.", "3 Carved Runes finish a Runestone. A Runestone makes Tar Drops forever."),
  'fire_brick': ("Clay needs a slow fire under it and iron rings to hold its shape.", "3 Oven Racks build a second Glass Oven."),
  'tar_spile': ("A Glass Float's worth of tubes and two iron tips. That is all a Tar Bucket is.", "3 Tar Buckets build a second Tar Oven."),
  'iron_billet': ("An Iron Helmet melted down, with a loaf of tar to keep the fire honest.", "3 Bellows build a second Shipwreck Forge."),
  'brass_cog': ("Iron melted and poured into meshing gear shapes.", "3 Gear Wheels build a second Star Workbench."),
  'silver_spindle': ("Iron pulled thin as thread around a ring of lenses, then set spinning.", "3 Spinning Wheels build a second Aurora Loom."),
