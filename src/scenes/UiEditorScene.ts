...
import { LIVE_GAME_WIDTH, LIVE_GAME_HEIGHT, SCENES } from '../core/Constants';
...
export class UiEditorScene extends Phaser.Scene {
  ...
  create(): void {
    ...
    const recipeHelp = new RecipeHelpPanel(this, ctx.bus, ctx.state, ctx.data.chains, ctx.data.cauldron, ctx.clock);
